 ...
 */
import { logTail_isCharsPerTokenFormat, logTail_isPositiveIntString, logTail_parseCharsPerTokenStrictPositive, } from "@gg-utils/platform-logs-core/validation";
...
export function logTailUiValidateViewPlan(config, plan) {
    const errors = [];
    ...
    if (source === undefined) {
        ...
        errors.push(`Unknown log scope '${plan.scope}' for source '${plan.source}'.`);
    }
...
export function logTailUiAssertValidViewPlan(config, plan) {
