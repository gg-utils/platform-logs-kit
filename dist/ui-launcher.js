...
export function PlatformLogsKit_formatUiHelpText(options) {
    const lines = [
        options.title,
        "",
        "Usage:",
    ...
    lines.push("Options:", "  --help           Show this help and exit.", "  --print-preview  Print command preview for the default plan and exit (no TUI).", "  --project-root   Repo root (default: cwd).", "", options.entryLabel, ...options.fallbackLines.map((line) => `  ${line}`));
...
//# sourceMappingURL=ui-launcher.js.map